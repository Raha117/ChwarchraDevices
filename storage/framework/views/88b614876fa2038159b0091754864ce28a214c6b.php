          ...
          <thead class="thead-dark">
            ...
            <tbody>
              ...
              <tr>
                ...
                <?php $__currentLoopData = $camera->device_specifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cameras_spec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <td scope="row"><?php echo e(ucfirst($cameras_spec->value)); ?></td>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <td> <?php echo e(date('h:i:s a m/d/Y', strtotime($camera->created_at))); ?> </td>
                <td> <?php echo e(date('h:i:s a m/d/Y', strtotime($camera->updated_at))); ?> </td>
                <td> <form method="get" action="/cameras/<?php echo e($camera->id); ?>/edit"><button type="submit" class="btn btn-success btn-xs btn-block">Update</button> </form></td>
                <td> <form method="post" action="/cameras/<?php echo e($camera->id); ?>"> <?php echo method_field('delete'); ?> <?php echo csrf_field(); ?> <button type="submit" class="btn btn-danger btn-xs btn-block">Delete</button> </form> </td>
              </tr>
...
<?php echo $__env->make('layout/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/raha/projects/ChwarchraProject/resources/views/cameras.blade.php ENDPATH**/ ?>